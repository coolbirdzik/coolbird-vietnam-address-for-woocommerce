...
?>
<div class="wrap coolbird_vietnam_address-settings-wrap coolbird_vietnam_address-modern-wrap">
    <div class="coolbird_vietnam_address-header">
        <h1><?php esc_html_e('Coolbird Vietnam Address for WooCommerce', 'coolbird-vietnam-address'); ?>
        </h1>
        <p class="coolbird_vietnam_address-header-desc">
    ...
    <!-- Tab Navigation -->
    <div class="coolbird_vietnam_address-tabs">
        <nav class="coolbird_vietnam_address-tabs-nav">
            <a href="#tab-address" class="coolbird_vietnam_address-tab active" data-tab="address">
                <span class="coolbird_vietnam_address-tab-icon">📍</span>
                <?php esc_html_e('Address', 'coolbird-vietnam-address'); ?>
            </a>
            <a href="#tab-currency" class="coolbird_vietnam_address-tab" data-tab="currency">
                <span class="coolbird_vietnam_address-tab-icon">💰</span>
                <?php esc_html_e('Currency & Shipping', 'coolbird-vietnam-address'); ?>
            </a>
            <a href="#tab-checkout" class="coolbird_vietnam_address-tab" data-tab="checkout">
                <span class="coolbird_vietnam_address-tab-icon">🛒</span>
                <?php esc_html_e('Checkout Fields', 'coolbird-vietnam-address'); ?>
            </a>
            <a href="#tab-orders" class="coolbird_vietnam_address-tab" data-tab="orders">
                <span class="coolbird_vietnam_address-tab-icon">📦</span>
        ...
        if (isset($_POST['save_coolbird_vietnam_address_settings']) && check_admin_referer('coolbird_vietnam_address_settings_nonce')) {
        ...
        ?>
        <form method="post" action="" novalidate="novalidate" class="coolbird_vietnam_address-settings-form">
            <?php wp_nonce_field('coolbird_vietnam_address_settings_nonce'); ?>
            <input type="hidden" name="save_coolbird_vietnam_address_settings" value="1" />

            <!-- Tab: Address (MOVE TO TOP) -->
            <div id="tab-address" class="coolbird_vietnam_address-tab-content active">
                <div class="coolbird_vietnam_address-card">
                    <div class="coolbird_vietnam_address-card-header">
                    ...
                    <div class="coolbird_vietnam_address-card-body">
                        <div class="coolbird_vietnam_address-field">
                            <label
                                for="address_schema"><?php esc_html_e('Address Format', 'coolbird-vietnam-address'); ?></label>
                            <div class="coolbird_vietnam_address-radio-group">
                                <label class="coolbird_vietnam_address-radio">
                                    ...
                                    <span class="coolbird_vietnam_address-radio-content">
                        ...
                        <div class="coolbird_vietnam_address-field">
                            <label class="coolbird_vietnam_address-toggle">
                                <input type="checkbox" name="<?php echo esc_attr($this->_optionName); ?>[active_village]"
                                    ...
                                    id="active_village" />
                                <span class="coolbird_vietnam_address-toggle-slider"></span>
                                <span class="coolbird_vietnam_address-toggle-label">
            ...
            <div id="tab-currency" class="coolbird_vietnam_address-tab-content">
                <div class="coolbird_vietnam_address-card">
                    <div class="coolbird_vietnam_address-card-header">
                ...
                <div class="coolbird_vietnam_address-card">
                    ...
                    <div class="coolbird_vietnam_address-card-body">
                        ...
                        <div class="coolbird_vietnam_address-field-row">
                            <div class="coolbird_vietnam_address-field">
                                <label
            ...
            <!-- Tab: Checkout Fields -->
            <div id="tab-checkout" class="coolbird_vietnam_address-tab-content">
                <div class="coolbird_vietnam_address-card">
                    <div class="coolbird_vietnam_address-card-header">
            ...
            <div id="tab-orders" class="coolbird_vietnam_address-tab-content">
                <div class="coolbird_vietnam_address-card">
                    <div class="coolbird_vietnam_address-card-header">
            ...
            <div class="coolbird_vietnam_address-submit">
                <?php submit_button(__('Save Changes', 'coolbird-vietnam-address'), 'primary coolbird_vietnam_address-btn-primary', 'save_coolbird_vietnam_address_settings', false); ?>
            </div>
        </form>
    </div>
</div>